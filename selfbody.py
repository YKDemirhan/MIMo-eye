...
class MIMoSelfBodyEnv(MIMoEnv):
    ...
    def sample_goal(self):
        ...
        self.target_bodies_array = ["","","","","","","","","","","","",""]
        self.target_bodies_array[0] = self.model.body(self.model.geom(22).bodyid).name
        self.target_bodies_array[1] = self.model.body(self.model.geom(18).bodyid).name
        self.target_bodies_array[2] = self.model.body(self.model.geom(21).bodyid).name
        self.target_bodies_array[3] = self.model.body(self.model.geom(17).bodyid).name
        self.target_bodies_array[4] = self.model.body(self.model.geom(20).bodyid).name
        self.target_bodies_array[5] = self.model.body(self.model.geom(16).bodyid).name
        self.target_bodies_array[6] = self.model.body(self.model.geom(2).bodyid).name
        self.target_bodies_array[7] = self.model.body(self.model.geom(3).bodyid).name
        self.target_bodies_array[8] = self.model.body(self.model.geom(4).bodyid).name#eye
        self.target_bodies_array[9] = self.model.body(self.model.geom(5).bodyid).name
        self.target_bodies_array[10] = self.model.body(self.model.geom(12).bodyid).name
        self.target_bodies_array[11] = self.model.body(self.model.geom(13).bodyid).name
        self.target_bodies_array[12] = self.model.body(self.model.geom(11).bodyid).name
        print (self.target_body)
        print (self.target_bodies_array)
        target_geom_onehot_nonrandomized = np.zeros(37)
        target_geom_onehot_nonrandomized[8] = 1
        return target_geom_onehot_nonrandomized
